...
router.get('/accounting', async (req, res) => {
    ...
    try {
        ...
        const response = await oauthClient.makeApiCall({
            url: `https://quickbooks.api.intuit.com/v3/company/9341453637872618/query?query=select * from Payment Where Metadata.LastUpdatedTime>'2015-01-16' Order By Metadata.LastUpdatedTime&minorversion=73`,
            method: 'GET',
            headers: {
